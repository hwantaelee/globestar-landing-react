    ...
    return (
        <div className="w-full px-4 py-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 text-label text-sm">
                ...
                <p>
                    <span className="font-black">30년 이상 철도시스템</span>
                    을 경험한 전문 기술인력을 활용하여 철도시스템 발주사가 설정한 목표를 프로젝트 진행단계에서 수행해야 하는 업무를 정의하여 문서화하고, 시스템 엔지니어링 개별분야 엔지니어들이 유기적으로 협력하여 시스템 엔지니어링 전체분야의 진행사항과 중요사항을 공유하며 개별 서브시스템을 전체로 통합했을 때 관련 서브시스템끼리 물리적, 성능적으로 적합하도록 발주사를 지원하고 공급사를 관리합니다.
                </p>
            </div>
